...
fun WeightScreen(
    ...
    Scaffold (
        ...
        Column(
            ...
            Text(text = "Select Weight", style = MaterialTheme.typography.headlineMedium)
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text(
                    text = state.weight.toString(), fontWeight = FontWeight.Bold, fontSize = 64.sp
                )
                Spacer(modifier = Modifier.width(16.dp))
                Text(text = "kg", style = MaterialTheme.typography.headlineMedium)
            ...
            Box() {
                Scale(
                    ...
                    onAction(OnboardingAction.SetWeight(it))
                }
            }
